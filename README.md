...
2) Удалён блок кода, отвечающий за остановку при необнаружении файлов. Этот блок приводил к преждевременной остановке выполнения. Сейчас скрипт продолжает выполняться даже если не оосталось фотографий, требуется перезакгрузка страницы.
